...
Откроем DataLens, зайдем в раздел подключения
...
Линейная сравнительная диаграмма суммарного трафика по времени с
указанием типа трафика

![](img/9.png)

4\. Создать дашборд

![](img/10.png) [Ссылка на итоговый
